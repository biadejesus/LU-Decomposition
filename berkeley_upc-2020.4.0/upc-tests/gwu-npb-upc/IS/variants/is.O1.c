...
void rank( int iteration ){
    ...
    memset(bucket_size_totals, 0, (NUM_BUCKETS + TEST_ARRAY_SIZE) * sizeof(INT_TYPE)) ;
    memset(process_bucket_distrib_ptr1, 0, (NUM_BUCKETS + TEST_ARRAY_SIZE) * sizeof(INT_TYPE)) ;
    memset(process_bucket_distrib_ptr2, 0, (NUM_BUCKETS + TEST_ARRAY_SIZE) * sizeof(INT_TYPE)) ;
