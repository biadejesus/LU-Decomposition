...
#if __BERKELEY_UPC_PTHREADS__
#error This release does not support the combination of <upc_collective.h> and `upcc -pthreads`. Please contact us if this feature is important to you!
#endif
