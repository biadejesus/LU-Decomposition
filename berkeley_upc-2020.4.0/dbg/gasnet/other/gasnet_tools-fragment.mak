...
GASNETTOOLS_LIBDIR = /home/beatrizdejesus/Documents/UEM/PC/projeto3/LU-Decomposition/berkeley_upc-2020.4.0/dbg/gasnet  ###NOINSTALL###
...
GASNETTOOLS_CFLAGS = -g3  -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address $(KEEPTMP_CFLAGS) $(MANUAL_CFLAGS)
GASNETTOOLS_LD = /usr/bin/gcc
GASNETTOOLS_LDFLAGS = -g3  -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address $(MANUAL_LDFLAGS)
...
GASNETTOOLS_CXXFLAGS = -g3  -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address $(MANUAL_CXXFLAGS)
