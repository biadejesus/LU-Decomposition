...
#define UPCRI_CONFIGURE_ARGS "'--with-translator=http://upc-translator.lbl.gov/upcc-2020.4.0.cgi' '--prefix=/usr/local/berkeley_upc/opt' '--with-multiconf-magic=opt'"
#define UPCRI_BUILD_ID "Tue Dec  8 15:09:09 -03 2020 beatrizdejesus"
