...
#define GASNETI_BUILD_ID "Tue Dec  8 15:09:13 -03 2020 beatrizdejesus"
#define GASNETI_CONFIGURE_ARGS "'--prefix=/usr/local/berkeley_upc/opt' '--with-translator=http://upc-translator.lbl.gov/upcc-2020.4.0.cgi' '--prefix=/usr/local/berkeley_upc/opt' '--with-multiconf-magic=opt' '--with-tool-prefix=upc' '--disable-parsync' '--srcdir=/home/beatrizdejesus/Documents/UEM/PC/projeto3/berkeley_upc-2020.4.0/gasnet'"
