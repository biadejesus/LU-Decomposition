...
UPCRI_ALIGNMENT_STRUCT(__uint128_t, __uint128_t);
UPCRI_IDENT_CHAR_ARRAY(upcri_IdentString_alignof_uint128_t) =
	{ UPCRI_IDENT_START_ALIGN, 'u','i','n','t','1','2','8','_','t','=',
	  UPCRI_ALIGNMENT_OF(__uint128_t) + UPCRI_IDENT_MAGIC_OFFSET, ' ','$','\0' };
#endif
