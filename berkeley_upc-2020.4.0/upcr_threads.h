...
extern gex_Client_t      upcri_client;
extern gex_EP_t          upcri_ep;
extern gex_TM_t          upcri_tm;
extern gex_Segment_t     upcri_segment;
...
extern gex_Rank_t   *upcri_thread2node;    /* maps UPC threads to nodes     */
...
typedef struct upcri_pthreadinfo {
    ...
    gasnet_threadinfo_t mygasnet_tinfo;	/* GASNet per-thread info	    */
...
#define upcri_1stthread(node)  (upcri_assert((gex_Rank_t)node < upcri_nodes), \
...
#define upcr_mythread()				(upcri_mynode)
...
#define upcr_nodes() ((upcr_thread_t)upcri_nodes)
extern gex_Rank_t upcri_nodes;

/* Current thread's node number */
#define upcr_mynode() ((upcr_thread_t)upcri_mynode)
extern gex_Rank_t upcri_mynode;
